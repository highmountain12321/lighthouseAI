...
const MixedWidgetRents: React.FC<Props> = ({className, chartColor, chartHeight}) => {
  ...
  return (
    <div className={`card ${className}`}>
      ...
      <div className={`card-header border-0 bg-${chartColor} py-5`}>
        <h3 className='card-title fw-bold text-white'>Rentals Progress</h3>
        ...
        <div className='card-rounded bg-body mt-n10 position-relative card-px py-15'>
          ...
          <div className='row g-0 mb-7'>
            ...
            <div className='col mx-5'>
              <div className='fs-6 text-gray-400'>Avarage Rentals</div>
