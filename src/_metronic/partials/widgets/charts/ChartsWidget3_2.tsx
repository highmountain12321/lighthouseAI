...
const ChartsWidget3_2: React.FC<Props> = ({className}) => {
  ...
  const [activeBtn, setActiveBtn] = React.useState('Year'); // Initially, Year is active
    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bold fs-3 mb-1'>Demand Rate</span>
        ...
        <div className='card-toolbar' data-kt-buttons='true'>
          <a
            ...
            id='kt_charts_widget_3_2_year_btn'
          ...
          <a
            ...
            id='kt_charts_widget_3_2_month_btn'
          ...
          <a
            className={`${getButtonStyle("Week")} px-4`} // Add px-4 to match the style of ChartsWidget3
            id='kt_charts_widget_3_2_week_btn'
      ...
      <div className='card-body'>
        {/* begin::Chart */}
        <div ref={chartRef} id='kt_charts_widget_3_2_chart' style={{height: '350px'}}></div>
        {/* end::Chart */}
      </div>
      {/* end::Body */}
    </div>
