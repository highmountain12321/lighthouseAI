    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bold fs-3 mb-1'>Top Performed Agents</span>
          <span className='text-muted mt-1 fw-semibold fs-7'>Over 100 most performed eeal-estate agents in your City</span>
        </h3>
        <div
          ...
          <table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
            ...
            <thead>
              <tr className='fw-bold text-muted'>
                ...
                <th className='min-w-120px'>Monthly Work</th>
                <th className='min-w-100px text-end'>Contacts</th>
              </tr>
            </thead>
            {/* end::Table head */}
            {/* begin::Table body */}
