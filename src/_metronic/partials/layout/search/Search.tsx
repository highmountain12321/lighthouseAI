...
import { setFilteredConversations } from 'app/redux/features/conversation-slice'
...
const Search: FC = () => {
  ...
  // Current Filters Show states
  const [showFilteredConversations, setShowFilteredConversations] = useState<boolean>(true);
  const [showFilteredChats, setShowFilteredChats] = useState<boolean>(true);
  ...
  const handleSearch = (text: string) => {
    ...
    if (text.length > 0) {
      const filteredConversations: Conversation[] = _conversationContents.filter((conversation: Conversation) => {
        return conversation.title.toLowerCase().includes(text.toLowerCase());
      });
          ...
          >
            ...
            >
              <div className='d-flex flex-stack fw-bold mb-4'>
                {/*begin::Label*/}
                <span className='text-muted fs-6 me-2'>Conversations: </span>
                {/*end::Label*/}
                {/*begin::Toolbar*/}
              ...
              <div ref={suggestionsElement} className='mb-4' data-kt-search-element='main'>
                <div className='scroll-y mh-200px mh-lg-325px'>
                  {_filteredConversations.map((conversation: Conversation, index: number) => {
                    return (
                      ...
                      >
                        <div className='symbol symbol-40px me-4'>
                          <span className='symbol-label bg-light text-primary'>
                        ...
                        <div className='d-flex flex-column'>
                          <Link to={`/chat-bot/chat/${conversation.id}`} className='fs-6 text-gray-800 text-hover-primary fw-bold'
                            onClick={() => {
                          ...
                          <span className='fs-7 text-muted fw-bold'>{new Date(conversation.updated_at).toLocaleString()}</span>
                        </div>
                      </div>
                    )
                  })}
              ...
              <div className='pb-4 border-bottom'>
                <label className='form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack'>
                  ...
                  <input
                    ...
                    checked={showFilteredConversations}
                    onChange={(e) => {
                      setShowFilteredConversations(e.target.checked);
                    }}
                  />
                </label>
              </div>
              ...
              <div className='py-4 border-bottom'>
                <label className='form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack'>
                  ...
                  <input
                    ...
                    type='checkbox'
                    checked={showFilteredChats}
                    onChange={(e) => {
                      setShowFilteredChats(e.target.checked);
                    }}
                  />
                </label>
              </div>
              ...
              <div className='py-4 border-bottom'>
                <label className='form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack'>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      setShowFilteredUsers(e.target.checked);
                    }}
                  />
                </label>
              </div>
