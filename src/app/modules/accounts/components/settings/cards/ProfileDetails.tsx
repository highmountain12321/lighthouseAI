...
// import { updateUser } from 'app/redux/thunks/userThunk'
import { updateUser } from 'app/modules/auth/core/_requests'
import { extractFirstAndLastName } from 'app/modules/dashboard/components/methods'
...
const ProfileDetails: React.FC = () => {
  ...
  const [user, loadingAuth, errorAuth] = useAuthState(firebaseAuth as any)

  const [loading, setLoading] = useState(false)

  let firstName = extractFirstAndLastName((currentUser) ? (currentUser?.displayName as string) : ('')).firstName
  let lastName = extractFirstAndLastName((currentUser) ? (currentUser?.displayName as string) : ('')).lastName
