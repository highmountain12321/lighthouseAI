            ...
            <span className='d-flex align-items-center me-2'>
              <span className='symbol symbol-50px me-6'>
                <span className='symbol-label'>
                  <KTIcon iconName='pencil' className='fs-1 text-gray-600' />
                </span>
              </span>
              ...
              <span className='d-flex flex-column'>
                ...
                <span className='fs-6 fw-bold text-gray-400'>
                   Using the powers of LighthouseGPT
                </span>
              </span>
            </span>

            <span className='form-check form-check-custom form-check-solid'>
              <span className='ml-10 text-black-500'>$20 </span>
          ...
          <label className='d-flex flex-stack mb-5 cursor-pointer'>
            <span className='d-flex align-items-center me-2'>
              ...
              <span className='d-flex flex-column'>
                ...
                <span className='fs-6 fw-bold text-gray-400'>Everything in The Reseacher plus AI-Consultation models</span>
              </span>
            </span>

            <span className='form-check form-check-custom form-check-solid'>
                <span className='mr-3 text-black-500'>$40</span>
          ...
          <label className='d-flex flex-stack mb-0 cursor-pointer'>
            <span className='d-flex align-items-center me-2'>
              ...
              <span className='d-flex flex-column'>
                ...
                <span className='fs-6 fw-bold text-gray-400'>
                  Everything included plus super-powerful recommendation systems
                </span>
              </span>
            </span>

            <span className='form-check form-check-custom form-check-solid'>
                <span className='mr-3 text-black-500'>$55</span>
